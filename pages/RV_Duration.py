...
def quantiles_(data):
    ...
    if last_data_point <= quantiles[1]:
        ...
        return 5
#Citi Surprise Index
US_citi_surprise_index = pd.read_csv("https://raw.githubusercontent.com/alitalbi/streamLit/9aaa5c059f196e2c4fe163f3a76190db0f646010/data/US%2010%20Year%20T-Note%20Futures%20Historical%20Data.csv",skiprows=[0],index_col=['Date'])
